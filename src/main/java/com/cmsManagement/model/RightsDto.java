...
import com.cmsManagement.dto.UserProfileType;
...
public class RightsDto {
	...
	@Column(name="right_type", length=15, unique=true, nullable=false)
	private String right_type = UserProfileType.USER.getUserProfileType();
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof RightsDto))
			return false;
		RightsDto other = (RightsDto) obj;
