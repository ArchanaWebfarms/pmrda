...
public class PasswordConstraintValidator implements ConstraintValidator<ValidPassword, String> {
    ...
    public void initialize(ValidPassword constraintAnnotation) {
    	/*try {
            ...
            String invalidPasswordList = this.getClass().getResource("CLASSPATH:WEB-INF/classes/invalid-password-list.txt").getFile();
            System.out.println("invalidPasswordList=="+invalidPasswordList);
