...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<div class="box-body">
	 <form:form  action="saveMeta?${_csrf.parameterName}=${_csrf.token}" modelAttribute="meta" commandName="meta"   class="form-horizontal" >
	...
	<div class="row">
		...
		<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="description">Type</label>
					<form:errors style="color: red"  path='type' />
					<div class="col-md-7">	
					<div class="input-group">
					  <span class="input-group-addon"><i class="fa fa-edit"></i></span>			
						<form:textarea type="text" path="type" id="type" class="form-control" />
					</div>	
					</div>
			</div>
		</div>
		...
		<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="description">Url</label>
					<form:errors style="color: red"  path='url' />
					<div class="col-md-7">	
					<div class="input-group">
					  <span class="input-group-addon"><i class="fa fa-edit"></i></span>			
						<form:textarea type="text" path="url" id="url" class="form-control" />
					</div>	
					</div>
			</div>
		</div>
      ...
      <div class="box box-default">
		 ...
		 <div class="box-footer">
                  <div class="form-actions floatRight">
					 <input type="submit" value="Save" id="Save"  class="btn btn-primary btn-flat margin"><%--  or <a href="<c:url value='/admin' />">Cancel</a> --%>
				 	 <input type="button" value="Cancel" onclick="location.href='metadatalist'" class="btn btn-success">
