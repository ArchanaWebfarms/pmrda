...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>  Enquiry Details <small>Preview</small> </h1>
      <ol class="breadcrumb">
        <li><a href="home"><i class="fa fa-dashboard"></i> <b>Home</b></a></li>
        <li><a href="enquiryDashboard">Enquiry Dashboard</a></li>
		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-12 invoice-col">
		          <br>		           
		          <h4><b>Name : </b>${feedBacks.name}</h4>
		          <h4><b>Phone : </b>${feedBacks.phone}</h4>        
		          <h4><b>Email : </b>${feedBacks.email}</h4>
		          <h4><b>Department : </b>${feedBacks.department.departmentName}</h4>
		          <h4><b>Subject : </b>${feedBacks.subject}</h4>        
		          <h4><b>Description : </b>${feedBacks.description}</h4>
		          <%-- <h4><b>Status : </b>${feedBacks.state}</h4> --%>
		        </div>
		      </div>
		      <br><br>
		    </section>	
