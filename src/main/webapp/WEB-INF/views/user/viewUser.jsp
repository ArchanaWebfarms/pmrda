		      ...
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-6 invoice-col">
		         ...
		         <%--  <h4><b>User ID : </b><c:out value="${userDto.user_id}"></c:out></h4>  --%>    
		          ...
		          <h4><b>Address : </b><c:out value="${userDto.address}"></c:out></h4>
		          <h4><b>Mobile Number : </b><c:out value="${userDto.mobileNumber}"></c:out></h4>        
		          <h4><b>Contact Number : </b><c:out value="${userDto.contactNummber}"></c:out></h4>
		          <h4><b>User Role : </b><c:out value="${userDto.roleID.role_type}"></c:out></h4>
		        </div>
		      </div>
		      <br><br>
		    </section>	
