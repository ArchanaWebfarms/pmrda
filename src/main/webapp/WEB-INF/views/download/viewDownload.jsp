...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>  Notice Details <small>Preview</small> </h1>
      <ol class="breadcrumb">
...
<div class="box-body">
				<div class="box box-default">
					<div class="box-header with-border">
						<h3 class="box-title">Notice Information</h3>
					</div>
					<!-- /.box-header -->
		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-6 invoice-col">
		          <h4><b>Title : </b>${downloads.title}</h4>
		          <h4><b>Description : </b>${downloads.description}</h4>        
		          <h4><b>Date : </b>${downloads.date}</h4>
		          <h4><b>Tags : </b>${downloads.tags}</h4>
		          <h4><b>Department : </b>${downloads.department.departmentName}</h4>
		        </div>
		      </div>
		      <br>
		    </section>	
