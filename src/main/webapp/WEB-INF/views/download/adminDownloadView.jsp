...
<div class="box-body">
		...
		<h3 class="lead">  <i class="fa fa-globe"></i> Basic Information :</h3>
		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-6 invoice-col">
		          <h4><b>Title : </b>${download.title}</h4>
		          <h4><b>Description : </b>${download.description}</h4>        
		          <h4><b>Date : </b>${download.date}</h4>
		          <h4><b>Tags : </b>${download.tags}</h4>
		          <h4><b>Department : </b>${download.department.departmentName}</h4>
		        </div>
		      </div>
		      <br>
            ...
            <tbody>
	            <tr>
						...
						<td>${download.attachment.attachmnt_name}</td>
						<td>${download.attachment.attachmnt_name}</td>
						<td><a href="attachmentDownload?path=${download.attachment.path}">Download</a></td>
	            </tr>   
            </tbody>
          </table>
		        </div>
		...
		<h3 class="lead">  <i class="fa fa-globe"></i> Change Status :</h3>
         ...
         <!-- /.box-header -->
      <section class="invoice">
      <form action="changeDownloadStatus">
      
      <input type="hidden" name="noticeID" value="${download.noticeID }">
		<div class="row">
