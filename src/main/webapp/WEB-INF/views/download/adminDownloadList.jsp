...
function selectStatus(){
	...
	var issueHTML = '<div class="box"><div class="box"><div class="box-header"><h3 class="box-title">Tenders Data Table</h3></div>'+
	'<div class="box-body"><table id="example1" class="table table-bordered table-striped">'+ 
	'<thead><tr><th>S.N.</th><th>Published Date</th><th>Title and Ref.No./Tender ID</th><th>Status</th><th id="tableAction">Action</th></tr>'+
	'</thead>'+
	'<tbody>';	
	
	var downloadStatus = $("#downloadStatus").val();
	 $.ajax({
			url:"getDownloadListByStatus?downloadStatus="+downloadStatus,
			success:function(response){
				...
				for(var i=0;i<response.length;i++){
					...
					'<td><a href="adminDownloadView?noticeId='+response[i].noticeID+'">Change Status</a></td>';
					}
					if(status==='Pending')
					{
					var j = i+1;
