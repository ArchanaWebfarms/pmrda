...
<div class="wrapper" >
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       <li><a href="home"><i class="fa fa-dashboard"></i> <b>Home</b></a></li>
        ...
        <li><a href="adminNoticesList">Admin Notifications list</a></li>
	...
	<!-- Default box -->
<div class="box-body">
 <form:form  action="NoticesStaus?${_csrf.parameterName}=${_csrf.token}" modelAttribute="notices" class="form-horizontal" commandName="notices">
          ...
          <div class="box-footer">
                  <div class="form-actions floatRight">
					 <input type="submit" value="Save" id="Save"  class="btn btn-primary btn-flat margin">
				 	 <input type="button" value="Cancel" onclick="location.href='adminNoticesList'" class="btn btn-success">
