...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> View Notifications Details  </h1>
      <ol class="breadcrumb">
		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-12 invoice-col">
		          <h4><b>Title : </b>${notices.title}</h4>
		          <h4><b>Title in Marathi: </b>${notices.title_h}</h4>
		          <h4><b>Description : </b>${notices.description}</h4>        
		          <h4><b>Publish Date : </b>${notices.publish_date}</h4>
		          <%-- <h4><b>Closing Date : </b>${notices.closingDate}</h4> --%>
		          <h4><b>Type : </b>${notices.type}</h4>		         
		          <h4><b>Department : </b>${notices.department.departmentName}</h4>
		        </div>
		      </div>
		      <br>
		    </section>	
