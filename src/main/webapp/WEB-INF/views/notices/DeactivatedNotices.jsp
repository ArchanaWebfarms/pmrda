    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       <li><a href="home"><i class="fa fa-dashboard"></i> <b>Home</b></a></li>
        ...
        <li><a href="adminDeleteNoticesList">Admin Notifications List</a></li>
        <li class="active">Deactivated Notifications</li>
       </ol>
    </section>
...
<div class="box-body">
 			<div class="box box-default">
					<div class="box-header with-border">
						<h3 class="box-title">Notifications Information</h3>
					</div>
					<!-- /.box-header -->
		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-12 invoice-col">
		           ...
		           <h5><b>Title : </b>${notices.title } </h5>
		              <h5><b>Title In Marathi : </b> ${notices.title_h }</h5> 
		          <h5><b>Description : </b>${notices.description }</h5>        
		          <h5><b>Date: </b>${notices.publish_date }</h5>
		           <h5><b>Type : </b>${notices.type }</h5>        
		          <h5><b>Department : </b>${notices.department.departmentName }</h5>		          
		          <h5><b>Creation Approval Status : </b>${notices.publishStatus}</h5> 	        	                
		          <h5><b>Creation Approval Date : </b>${notices.approveddate}</h5>
		          <h5><b>Creation Approval Comment : </b>${notices.comment}</h5>
		          <h5><b>Deletion Approval Status : </b>${notices.delete_approval_status}</h5>
		          <h5><b>Deletion Approval Date : </b>${notices.delete_approval_date}</h5>
		          <h5><b>Deletion Approval Comment : </b>${notices.delete_approval_comment}</h5> 
