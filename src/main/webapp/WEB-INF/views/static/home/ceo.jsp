  ...
  <meta name="viewport" content="width=device-width" />
    <meta name="keywords" content="ceo of pmrda pmrda ceo,Metropolitan Commissioner,Commissioner of Metropolitan">
     <meta name="description" content=" ceo of pmrda,about pmrda ceo"/>
      <title>.::<spring:message code="ceo.title"  /> ::.</title>
     <style>
     .text-center p{
     text-align:justify;
     }
   ...
   <body>
     ...
     <%--  <div id="maincontent"   class="container">
         ...
         <div class="container-fluid au-cmm-container text-center" style="margin-top:30px;"> 
             <div class="row">
				<img src="staticResources/t3-assets/images/Shri Suhas Diwase.jpeg" style="margin:auto;"><br/><br/>
				<h3 style="width:100%;"><spring:message code="ceo.body.h1"  /></h3>
				<h4 style="width:100%;"><spring:message code="ceo.body.h2"  /></h4>
				<div  style="width:100%;">
				...
				<br/>
				<p><spring:message code="ceo.body.p1"  /></p>
				<p><spring:message code="ceo.body.p2"  /></p>
				<p><spring:message code="ceo.body.p3"  /></p>
