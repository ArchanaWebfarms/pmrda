...
<html prefix="og: http://ogp.me/ns#" lang="en-gb" dir="ltr" class='com_content view-featured itemid-550 j38 mm-hover'>
  ...
  <meta name="viewport" content="width=device-width" />
      <title>.:: <spring:message code="Quotations.pagetitle"  />  ::.</title>
   ...
   <body>
    ...
    <%--   <div class="container">
         <section class="wrap t3-navhelper" style="margin-top: 0px;">
               <div class="row">
                  <ol class="breadcrumb ">
                  <li class="active">  <spring:message code="navigation.container.li1"  /> &nbsp;</li><li><i class="fas fa-caret-right"></i> <a href="./index.htm" class="pathway">  <spring:message code="navigation.container.li2"  /></a></li><li><i class="fas fa-caret-right"></i> <a href="#" class="pathway">  <spring:message code="table.heading.Download"  /></a></li><li><i class="fas fa-caret-right"></i> <span><spring:message code="Quotations.pagetitle"  /></span></li></ol>
               </div>
            </section>
            <hr/>
      </div> --%>
      ...
      <div id="t3-mainbody  maincontent"    class="container-fluid t3-mainbody dl-container" style="margin-top:30px;">
         <div class="row">
            <div class="itemHeader">
             ...
             <spring:message code="Quotations.t3-mainbody.itemTitle.h2"/> <a href ="Archive_quotationnotice" style="color:green;font-size: 22px"  class="archiveLink"><spring:message code="archive.archived.quotations" /></a>
               </h2>
...
function searchNoticesByDepartment(){
  ...
  var departments = $("#departments").val();
     ...
     $.ajax({
			url:"searchNoticesByDepartment?departments="+departments+"&noticeType=QUOTATIONS"+"&category=NOTICE",
...
function SubmitDates(){
  ...
  if(language=="marathi")
     ...
     $.ajax({
		 url:"noticebydates?fromdate="+fromdate+"&todate="+todate+"&type=QUOTATIONS",
			success:function(response){
				console.log(response)
