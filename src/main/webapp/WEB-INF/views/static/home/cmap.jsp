  ...
  <meta name="viewport" content="width=device-width" />
    <meta name="keywords" content="">
     ...
     <link rel="icon" href="staticResources/images/PMRDALogo1.png" type="image/png" >
      <title>.:: <spring:message code="cmap.div.h4"  /> ::.</title>
	  <style>
      ...
      <div id="maincontent"   class="container-fluid" style="margin-top:30px;">
                 ...
                 <div class="col-sx-12 col-sm-12 col-md-12" style="border-left: 1px solid #eaeaea; padding: 0px 25px;">
                  <div class="static_content">
                            ...
                            <div class="bloginfo">
                            <h4 style="margin-bottom: 0px;"><spring:message code="cmap.div.h4"  /></h4><br>
                            <p><spring:message code="cmap.div.h4.p1"  /></p> 
                             <p><spring:message code="cmap.div.h4.p2"  /></p>
                                  <ul>
                                 <li class="even"><spring:message code="cmap.div.ul.li1"  /></li>
                                 <li class="even"><spring:message code="cmap.div.ul.li2"  /></li>
                                  <li class="even"><spring:message code="cmap.div.ul.li3"  /></li>
                                   <li class="even"><spring:message code="cmap.div.ul.li4"  /></li>
                                 <li class="even"><spring:message code="cmap.div.ul.li5"  /></li>
                                  <li class="even"><spring:message code="cmap.div.ul.li6"  /></li>
                                  <li class="even"><spring:message code="cmap.div.ul.li7"  /></li>
                               </ul>
                               
                               
                            <p><spring:message code="cmap.div.p3"  /></p>
                           <p><u><strong><spring:message code="cmap.div.p4"  /></strong></u></p>
                           ...
                           <spring:message code="cmap.div.p8"  /><spring:message code="cmap.div.p.phone"  /><br>
