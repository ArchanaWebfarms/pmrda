         ...
         <div class="row">
            <div class="itemHeader">
               ...
               <h2 class="itemTitle">
                  ...
                  <spring:message code="pressnotes.title"  /><div class="blink"><span class = "spanblink"><spring:message code="archive.blink"/></span></div>
               </h2>
  ...
  if(language=="marathi")
	 ...
	 issueHTML = 
		 '<div class="box-body"><table id="example" class="table table-bordered table-striped dl-table">'+ 
			'<thead><tr><th>अनुक्रमांक</th> <th>शीर्षक</th> <th>प्रकार</th> <th> तारीख </th> <th>बंद होण्याची तारीख</th><th>डाउनलोड करा</th></tr>'+
			'</thead>'+
			'<tbody>';	
	 }
  else{
	  issueHTML = 
		  '<div class="box-body"><table id="example" class="table table-bordered table-striped dl-table">'+ 
			'<thead><tr><th>Sr. No.</th><th>Title</th><th>Type</th><th> Date </th><th>Closing Date</th><th>Download</th></tr>'+
			'</thead>'+
			'<tbody>';	
  }
     ...
     $.ajax({
		 url:"Archive_PressNotes_bydates?fromdate="+fromdate+"&todate="+todate,
				 data:formData,
			success:function(response){
				...
				for(var i=0;i<response.length;i++){   
					...
					if(language=="marathi"){
						...
						department=response[i].departmen;
					} 
				    var j = i+1;
