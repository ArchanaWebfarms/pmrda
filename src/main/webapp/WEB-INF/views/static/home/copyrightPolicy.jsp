  ...
  <meta name="viewport" content="width=device-width" />
    <meta name="keywords" content="">
     ...
     <link rel="icon" href="staticResources/images/PMRDALogo1.png" type="image/png" >
      <title>.:: <spring:message code="copyRightPolicy.title"  />::.</title>
	  <style>
      ...
      <div id="maincontent"   class="container-fluid" style="margin-top:30px;">
                 ...
                 <div class="col-sx-12 col-sm-12 col-md-12" style="border-left: 1px solid #eaeaea; padding: 0px 25px;">
                  <div class="static_content">
                            ...
                            <div class="bloginfo">
                            <h4 style="margin-bottom: 0px;"><spring:message code="copyRightPolicy.div.h4"  /></h4><br>
                            <p><spring:message code="copyRightPolicy.div.h4.p1"  /></p> 
                           ...
                           <spring:message code="cmap.div.p8"  /> <spring:message code="copyRightPolicy.div.p8.ph"  /><br>
