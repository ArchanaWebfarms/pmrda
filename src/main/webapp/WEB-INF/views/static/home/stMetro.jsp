  ...
  <meta name="viewport" content="width=device-width" />
    <meta name="keywords" content="Administration Department,dept of administration,administration department of pmrda pmrda administration">
     ...
     <link rel="icon" href="staticResources/images/PMRDALogo1.png" type="image/png" >
      <title>.:: <spring:message code="metro.stProject.title"  /> ::.</title>
	  <style>
				...
				<div class="b-l-m-container">
                     <ul>
                      <li><a  href="#"><spring:message code="Header.Menu.Projects"  /></a></li>
                        <li><a class="active" href="metro"><spring:message code="metro.stProject.title"  /></a></li>
...
<spring:message code="metro.stProject.title"  />
			</h2>
			...
			<div class="catItemIntroText">
			 ...
			 <h4><spring:message code="metro.stProject.h1"  /></h4> 
			<p><spring:message code="metro.stProject.p11"  /></p>
			<p><spring:message code="metro.stProject.p12"  /></p>
			
			<ul>
				<li><spring:message code="metro.stProject.p13"  /></li>
				<li><spring:message code="metro.stProject.p14"  /></li>
				<li><spring:message code="metro.stProject.p15"  />
					<ul style="list-style:decimal">
						<li><spring:message code="metro.stProject.p17"  /></li>
						<li><spring:message code="metro.stProject.p18"  /></li>
						<li><spring:message code="metro.stProject.p19"  /></li>
					</ul>
				</li>
				<li><spring:message code="metro.stProject.p110"  /></li>
				<li><spring:message code="metro.stProject.p111"  /></li>
				<li><spring:message code="metro.stProject.p112"  /></li>
				<li><spring:message code="metro.stProject.p113"  /></li>
				<li><spring:message code="metro.stProject.p114"  /></li>
				<li><spring:message code="metro.stProject.p115"  /></li>
				
				
			</ul>
			
			
			 <h4><spring:message code="metro.stProject.h2"  /></h4>
			<img src="staticResources/images/metroPhoto.PNG" style="margin-bottom:20px;" alt="Metro" title="Metro">
