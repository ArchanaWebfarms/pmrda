...
<html prefix="og: http://ogp.me/ns#" lang="en-gb" dir="ltr" class='com_content view-featured itemid-550 j38 mm-hover'>
  ...
  <meta name="viewport" content="width=device-width" />
      <title>.:: <spring:message code="termconditions.title"  /> ::.</title>
      ...
      <div id="maincontent"  class="container-fluid" style="margin-top:30px;">
                 ...
                 <div class="col-sx-12 col-sm-12 col-md-12" style="border-left: 1px solid #eaeaea; padding: 0px 25px;">
                  <div class="static_content">
                            <div class="bloginfo">
                            <h4 style="margin-bottom: 0px;"> <spring:message code="termconditions.title"  /></h4><br>
                          <p> <spring:message code="termconditions.div.p1"  /></p>
                          <p> <spring:message code="termconditions.div.p2"  /></p>
                          <p> <spring:message code="termconditions.div.p3"  /></p>
                </div>
               </div>
