...
<html prefix="og: http://ogp.me/ns#" lang="en-gb" dir="ltr" class='com_content view-featured itemid-550 j38 mm-hover'>
  ...
  <meta name="viewport" content="width=device-width" />
    <meta name="keywords" content="pune digital policy,digital policy of pmrda">
     <meta name="description" content=" The Pune Metropolitan Region Development Authority has launched a revolutionary app to curb illegal construction in the Pune Metropolitan Region."/>
      
      <title>.:: <spring:message code="policy.title"  /> ::.</title>
      <style>
      ...
      <div class="t3-wrapper t3-homepage-2">
         ...
         <div id="maincontent"  class="container-fluid au-container" style="margin-top:30px;"> 
                        ...
                        <li><a  href="objectives"><spring:message code="background.b-l-m-container.li4"  /><i class="fas fa-arrow-circle-right"></i></a></li>
                         <li><a  href="pmrda_establishment"><spring:message code="background.b-l-m-container.li7"  /><i class="fas fa-arrow-circle-right"></i></a></li>
                          <li><a href="master_plan"><spring:message code="background.b-l-m-container.li8"  /><i class="fas fa-arrow-circle-right"></i></a></li>
                           <li><a class="active" href="digital_policy"><spring:message code="background.b-l-m-container.li9"  /><i class="fas fa-arrow-circle-right"></i></a></li>
                        ...
                        <li><a href="objectives"><spring:message code="background.b-l-m-container.li4"  /></a></li>
                         <li><a href="pmrda_establishment"><spring:message code="background.b-l-m-container.li7"  /></a></li>
                          <li><a href="master_plan"><spring:message code="background.b-l-m-container.li8"  /></a></li>
                           <li><a class="active" href="digital_policy"><spring:message code="background.b-l-m-container.li9"  /></a></li>
            ...
            <div class="col-sx-12 col-sm-12 col-md-10 grayback" style="border-left: 1px solid #eaeaea; padding: 0px 25px;">
                  <div class="bloginfo">
                                <h3 style="margin-bottom: 0px;"><spring:message code="policy.title"  /> :</h3>
                                <div class="clear"></div>
                            </div>
                            <div class="clear"></div>
				  ...
				  <div class="blog_detail">
                            ...
                            <p style="color: black">
<spring:message code="policy.blog_detail.p1"  /> 
                           </p>
                           <p style="text-align:justify;color: black">
<spring:message code="policy.blog_detail.p2"  /> 
                           </p>
                           
                            <div class="clear"></div>
                            <br>
                            <p style="color: black">  <spring:message code="policy.blog_detail.p3"  />  </p>
                            <p style="color: black"><spring:message code="policy.blog_detail.p4"  />  </p>
                            <p style="color: black"><spring:message code="policy.blog_detail.p5"  />   </p>
                            <p style="color: black"><spring:message code="policy.blog_detail.p6"  />   </p>
                           <p style="text-align:justify;color: black">
<spring:message code="policy.blog_detail.p7"  /> 
                           </p>
