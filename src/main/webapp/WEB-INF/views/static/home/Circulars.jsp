...
<html prefix="og: http://ogp.me/ns#" lang="en-gb" dir="ltr" class='com_content view-featured itemid-550 j38 mm-hover'>
 ...
 <%
  ...
  <meta name="viewport" content="width=device-width" />
      <title>.:: <spring:message code="Header.Menu.AboutUs.notifications" />::.</title>
               ...
               <li><a href="#"><spring:message code="Header.Menu.Downloads" /> </a></li>
                   <li>  <a href="act"><spring:message code="Header.Menu.AboutUs.acts" /></a></li>
					<li>	    <a href="govresolution"><spring:message code="Header.Menu.AboutUs.govresol" /></a></li>						
						<li>     <a class="active" href="pmrda_circulars"><spring:message code="Header.Menu.AboutUs.notifications" /></a></li>
...
function searchNoticesByDepartment(){
  ...
  var departments = $("#departments").val();
     ...
     $.ajax({
			url:"searchNoticesByDepartment?departments="+departments+"&noticeType=CIRCULERS"+"&category=NOTICE",
...
function SubmitDates(){
  ...
  if(language=="marathi")
     ...
     $.ajax({
		 url:"noticebydates?fromdate="+fromdate+"&todate="+todate+"&type=CIRCULERS",
			success:function(response){
				console.log(response)
