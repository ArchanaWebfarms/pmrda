...
<html prefix="og: http://ogp.me/ns#" lang="en-gb" dir="ltr" class='com_content view-featured itemid-550 j38 mm-hover'>
  ...
  <meta name="viewport" content="width=device-width" />
     <meta name="description" content=" "/>
      <title>.:: <spring:message code="index.Downloads"  /> ::.</title>
   ...
   <body>
     ...
     <%--  <div class="container">
         <section class="wrap t3-navhelper" style="margin-top: 0px;">
               <div class="row">
                  <ol class="breadcrumb ">
                  <li class="active">  <spring:message code="navigation.container.li1"  /> &nbsp;</li><li><i class="fas fa-caret-right"></i> <a href="./index.htm" class="pathway">  <spring:message code="navigation.container.li2"  /></a></li><li><i class="fas fa-caret-right"></i> <a href="#" class="pathway">  <spring:message code="table.heading.Download"  /></a></li><li><i class="fas fa-caret-right"></i> <span><spring:message code="index.Downloads"  /></span></li></ol>
               </div>
            </section>
            <hr/>
      </div> --%>
<input type="hidden" name="lang" id="lang" value="<%=LocaleContextHolder.getLocale()%>">
      ...
      <div id="t3-mainbody  id="maincontent"    class="container-fluid t3-mainbody dl-container" style="margin-top:30px;">
         <div class="row">
            <div class="itemHeader">

               <h2 class="itemTitle">
               
              <spring:message code="index.Downloads"  /> <a href ="Archive_Downloadnotice" style="color:green;font-size: 22px"  class="archiveLink"><spring:message code="archive.archived.downloads" /></a>
               </h2>
         ...
         <div id="englishtable" style="display: visible;">
       ...
       <div id="marathitable" style="display: none;">
         ...
         <tr>
            <th scope="col" style="width:10%;">अनुक्रमांक</th><th scope="col">शीर्षक</th><th scope="col">तारीख</th><th scope="col">विभाग</th><th scope="col">डाउनलोड करा</th>
         </tr>
          <c:forEach var="approvedNotice" items="${approvedNotice}" varStatus="status">
...
/* function SubmiotDates(){
  ...
  if(language=="marathi")
	...
	'<tbody>';	
     ...
     $.ajax({
		 url:"sendbothdates?fromdate="+fromdate+"&todate="+todate+"&Type=DOWNLOADS",
...
function searchNoticesByDepartment(){
  ...
  var departments = $("#departments").val();
     ...
     $.ajax({
			url:"searchNoticesByDepartment?departments="+departments+"&noticeType=DOWNLOADS"+"&category=NOTICE",
			success:function(response){
				//alert(response.length);
...
function SubmitDates(){
  ...
  if(language=="marathi")
     ...
     $.ajax({
		 url:"noticebydates?fromdate="+fromdate+"&todate="+todate+"&type=DOWNLOADS",
			success:function(response){
				console.log(response)
