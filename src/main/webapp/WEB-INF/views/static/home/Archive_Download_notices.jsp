         ...
         <div class="row">
            <div class="itemHeader">
               ...
               <h2 class="itemTitle">
                  ...
                  <spring:message code="index.Downloads"  /><div class="blink"><span class = "spanblink"><spring:message code="archive.blink"/></span></div>
               </h2>
...
function SubmitDates(){
  ...
  if(language=="marathi")
     ...
     $.ajax({
		 url:"Archive_Download_noticesbydates?fromdate="+fromdate+"&todate="+todate,
