...
<%
  ...
  <meta name="viewport" content="width=device-width" />
      <title>.::<spring:message code="cm.title"  /> ::.</title>
 ...
 --%>
         ...
         <div  id="maincontent"   class="container-fluid au-cmm-container text-center" style="margin-top:30px;"> 
            <div class="row">
				<img src="staticResources/images/icon/cm.png" style="margin:auto;"><br/><br/>
				<h3 style="width:100%;"><spring:message code="cm.body.h1"/></h3>
				<h4 style="width:100%;"><spring:message code="cm.body.h2"/></h4>
				<div  style="width:100%;">
				...
				<br/>
				<p><spring:message code="cm.body.p1"  /></p>
				<p><spring:message code="cm.body.p2"  /></p>
				<p><spring:message code="cm.body.p3"  /></p>
