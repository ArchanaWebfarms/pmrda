...
<html prefix="og: http://ogp.me/ns#" lang="en-gb" dir="ltr" class='com_content view-featured itemid-550 j38 mm-hover'>
  ...
  <meta name="viewport" content="width=device-width" />
      ...
      <title>.:: <spring:message code="investment.title"  /> ::.</title>
	  <style >
	  p{
	  text-align:justify;
	  }
   ...
   <body>
    ...
    <%--   <div class="container">
         <section class="wrap t3-navhelper" style="margin-top: 0px;">
               <div class="row">
                  <ol class="breadcrumb ">
                  <li class="active">  <spring:message code="navigation.container.li1"  /> &nbsp;</li><li><i class="fas fa-caret-right"></i> <a href="./index.htm" class="pathway">  <spring:message code="navigation.container.li2"  /></a></li><li><i class="fas fa-caret-right"></i> <a href="#" class="pathway">  <spring:message code="department.navigation"  /></a></li><li><i class="fas fa-caret-right"></i> <span><spring:message code="investment.title"  /></span></li></ol>
               </div>
            </section>
            <hr/>
      </div> --%>
		...
		<div id="maincontent"    class="deptpage container-fluid t3-mainbody administration-container" style="margin-top:30px;">
          ...
          <div class="t3-sidebar t3-sidebar-right col-xs-12 col-sm-2 col-md-2 col-lg-2" style="padding-right: 25px;">
				...
				<div class="b-l-m-container">
                     <ul>
                       ...
                       <li><a href="permission"><spring:message code="department.b-l-m-container.li3"  /></a></li>
                        ...
                        <li><a class="active" href="Investment"><spring:message code="department.b-l-m-container.li10"  /></a></li> 
                        </ul>
                  </div>
				</div>
				</div>
			...
			<spring:message code="investment.itemTitle"  /> 
			</h3>
			...
			<h4><spring:message code="investment.catItemIntroText.h1"  /></h4>

			<p><spring:message code="investment.catItemIntroText.p1"  /></p>
			
			
			
			
			<h4><spring:message code="investment.catItemIntroText.h2"  /></h4>			
				<p><spring:message code="investment.catItemIntroText.p2"  /></p>
				<ul>
					<li><spring:message code="investment.catItemIntroText.p3"  /></li>
					<li><spring:message code="investment.catItemIntroText.p4"  /></li>
					<li><spring:message code="investment.catItemIntroText.p5"  /></li>
					<li><spring:message code="investment.catItemIntroText.p6"  /></li>
				</ul>
					
									<p><spring:message code="investment.catItemIntroText.p7"  /></p>
