         ...
         <div class="row">
            <div class="itemHeader">
               ...
               <h2 class="itemTitle">
                  ...
                  <spring:message code="circulers.t3-mainbody.itemTitle.h2"/><div class="blink"><span class = "spanblink"><spring:message code="archive.blink"/></span></div>
               </h2>
  ...
  if(language=="marathi")
	 ...
	 issueHTML = 
		 '<div class="box-body"><table id="example" class="table table-bordered table-striped dl-table">'+ 
			'<thead><tr><th>अनुक्रमांक</th> <th>शीर्षक</th> <th>प्रकार</th> <th>प्रकाशन तारीख </th> <th>बंद होण्याची तारीख</th><th>डाउनलोड करा</th></tr>'+
			'</thead>'+
			'<tbody>';	
	 }
  else{
     ...
     $.ajax({
		 url:"Archive_Circulars_noticesbydates?fromdate="+fromdate+"&todate="+todate,
