  ...
  <meta name="viewport" content="width=device-width" />
    <meta name="keywords" content="Administration Department,dept of administration,administration department of pmrda pmrda administration">
     ...
     <link rel="icon" href="staticResources/images/PMRDALogo1.png" type="image/png" >
      <title>.:: <spring:message code="ringroad.stProject.title"  /> ::.</title>
	  <style>
				...
				<div class="b-l-m-container">
                     <ul>
                      <li><a  href="#"><spring:message code="Header.Menu.Projects"  /></a></li>
                        ...
                        <li><a  class="active"  href="PuneRingRoad"><spring:message code="ringroad.stProject.title"  /></a></li>
...
<spring:message code="ringroad.stProject.title"  />
			</h2>
			...
			<div class="catItemIntroText">
			 ...
			 <h4><spring:message code="ringroad.stProject.h1"  /></h4> 
			<p><spring:message code="ringroad.stProject.p11"  /></p>
			<p><spring:message code="ringroad.stProject.p12"  /></p>
			<p><spring:message code="ringroad.stProject.p13"  /></p>
			<p><spring:message code="ringroad.stProject.p14"  /></p>
			
			
			 <h4><spring:message code="ringroad.stProject.h2"  /></h4> 
			<p><spring:message code="ringroad.stProject.p21"  /></p>
			<p><spring:message code="ringroad.stProject.p22"  /></p>
			<p><spring:message code="ringroad.stProject.p23"  /></p>
		
		 <h4><spring:message code="ringroad.stProject.h3"  /></h4> 
			<p><spring:message code="ringroad.stProject.p31"  /></p>
