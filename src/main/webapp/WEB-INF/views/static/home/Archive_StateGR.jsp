         ...
         <div class="row">
            <div class="itemHeader">
               ...
               <h2 class="itemTitle">
                  ...
                  <spring:message code="SG.t3-mainbody.itemTitle.h2"  /><div class="blink"><span class = "spanblink"><spring:message code="archive.blink"/></span></div>
               </h2>
...
function SubmitDates(){
  ...
  if(language=="marathi")
     ...
     $.ajax({
		 url:"Archive_Stategrbydates?fromdate="+fromdate+"&todate="+todate,
