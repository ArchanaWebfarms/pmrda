						...
						<div class="box-header with-border">
							...
							<section class="content-header">
								...
								<ol class="breadcrumb">
									...
									<li><a href="photoGallaryList">Photo Gallery</a></li>
...
<hr>
							...
							<section class="content">
								...
								<div class="box-body">
									<div class="row">
										<form method="POST"
										action="uploadPhotoGallary?${_csrf.parameterName}=${_csrf.token}"
										...
										<div class="row" id="attach">
											<div class="form-group col-md-12">
												<label class="col-md-3 control-lable" for="attachment">Photo
