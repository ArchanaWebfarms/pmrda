...
<div class="box-body">
				<div class="box box-default">
					<div class="box-header with-border">
						<h3 class="box-title">Taluka Information</h3>
					</div>
					<!-- /.box-header -->
		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-12 invoice-col">
		           <h4><b>Taluka : </b>${taluka.taluka}</h4>   
		             <h4><b>Taluka in Marathi: </b>${taluka.taluka_h}</h4>   
		            <h4><b>Total No.of Villages : </b>${taluka.total_villages}</h4>	             
		          <h4><b>Remark : </b>${taluka.remark}</h4>
		          <h4><b>Remark in Marathi : </b>${taluka.remark_h}</h4> 	          	                
		          <h4><b>Creation Date : </b>${taluka.created_on}</h4>
