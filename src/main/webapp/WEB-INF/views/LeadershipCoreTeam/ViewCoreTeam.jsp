    ...
    <section class="content-header">
     <h1> View Core Team Form  </h1>
      ...
      <li><a href="home"><i class="fa fa-dashboard"></i> <b>Home</b></a></li>
        ...
        <li class="active">View Core Team</li>
      </ol>
    </section>
...
<div class="box-body">
				<div class="box box-default">
					<div class="box-header with-border">
						<h3 class="box-title">Core Team Information</h3>
					</div>
					<!-- /.box-header -->
		      ...
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-12 invoice-col">
		         <h4><b>Sequence : </b>${leader.sequence}</h4>   
		          ...
		          <h4><b>Department in English : </b>${leader.department.departmentName}</h4> 	 
		          <h4><b>Department in Marathi : </b>${leader.department.departmentName_h}</h4> 	 
