...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Leadership Registration Form   </h1>
      <ol class="breadcrumb">
        ...
        <li class="active">New Leadership</li>
      </ol>
    </section>
	...
	<div class="box-body">
	 <form:form  action="saveLeadership?${_csrf.parameterName}=${_csrf.token}" modelAttribute="leader" commandName="leader"  enctype="multipart/form-data"   class="form-horizontal" >
			...
			<div class="form-group col-md-12">
				...
				<div class="col-md-7">
					<div class="input-group">
					  ...
					  <form:input path="sequence" id="sequence" class="form-control" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)"/>
				    </div> 
				</div>
			</div>
		</div>
				...
				<div class="form-group col-md-12">
					...
					<div class="input-group">
					  <span class="input-group-addon"><i class="fa fa-edit"></i></span>			
	                   ...
	                   <div class="row">
				                  <div class="form-group col-md-12">
					               <label class="col-md-3 control-lable">Description in English<sup>*</sup></label>
		                           ...
		                           <div class="row">
				                  <div class="form-group col-md-12">
					               <label class="col-md-3 control-lable">Description in Marathi<sup>*</sup></label>
	            ...
	            <tr>
	                  ...
	                  <div class="box-footer">
                          <div class="form-actions floatRight">
				 	           ...
				 	           <input type="button" value="Cancel" onclick="location.href='leadershipList'" class="btn btn-success">
