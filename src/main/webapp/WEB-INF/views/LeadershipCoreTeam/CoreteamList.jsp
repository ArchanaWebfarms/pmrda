 ...
 <div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Core Team Data Table  <!-- <small>advanced tables</small> --></h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Core Team List</li>   
      </ol>
     
      <!-- /.row -->
      <div class="box">
            <div class="box-header">
              <h3 class="box-title">For New Core Team Register Here...</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             	<div class="form-actions floatRight">
					 <button type="button" onclick="location.href='newCoreTeam'" class="btn btn-primary btn-flat margin">Add New</button>
				</div>
            </div>
            <!-- /.box-body -->
         </div>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
 			...
 			<div class="box">
 			<h3> Core Team Data Table<!-- <small>advanced tables</small> --></h3>
            <div class="box-header">
...
<!-- DataTables -->
  ...
  <form:form  action="viewCoreTeam" id="viewform" oncontextmenu="return false" onkeydown="return false;" onmousedown="return false;" >  	
  <input type="hidden" id="viewid" name="id" />  
  </form:form>
  
  <form:form  action="editCoreTeam" id="editform" oncontextmenu="return false" onkeydown="return false;" onmousedown="return false;" >  	
  <input type="hidden" id="editid" name="id" />  
  </form:form>
  
  <form:form  action="deleteCoreTeam" id="deleteform" oncontextmenu="return false" onkeydown="return false;" onmousedown="return false;" >  	
