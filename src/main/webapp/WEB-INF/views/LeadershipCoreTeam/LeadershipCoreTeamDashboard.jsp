...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Leadership and Core Team Dashboard
      </h1>
      <ol class="breadcrumb">
        <li><a href="home"><i class="fa fa-dashboard"></i> <b>Home</b></a></li>
        <li class="active">Leadership and Core Team Dashboard</li>
      </ol>
    </section>
       ...
       <div class="col-lg-3 col-xs-6">
         <!--  small box -->
          <div class="small-box bg-blue">
            ...
            <a href="leadershipList" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <br>
				<br>
				<br>
             <p> Core Team Dashboard</p>
            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            <a href="coreteamList" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
