		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-12 invoice-col">
		          ...
		          <h4><b>Tender ID : </b>${tendors.subTitle}</h4>
		          <h4><b>Description : </b>${tendors.description}</h4> 
		           <h4><b>Publish Date : </b>${tendors.publish_date}&nbsp;${tendors.publish_time}</h4>  
		           <h4><b>Closing Date : </b>${tendors.closingDate}&nbsp;${tendors.closing_time}</h4>             
		          <h4><b>Opening Date : </b>${tendors.openingDate}&nbsp;${tendors.opening_time}</h4>
...
/* function downLoadAttachment(){
	var attachmentID = $("#downloadAth").val();
	alert("attachmentID "+attachmentID);
	 $.ajax({
			url:"attachmentDownload?attachmentID="+attachmentID,
