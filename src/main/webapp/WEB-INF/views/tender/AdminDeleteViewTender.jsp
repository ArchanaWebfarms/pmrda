...
<div class="box-body">
		...
		<form action="DeleteTenderStatus"  class="form-horizontal" >
	
		<input type="hidden" value="${tender.id}" name="id" id="id">
		<div class="box-body" id="attachmentavailable">
		<div class="row">
        <div class="col-xs-12 table-responsive">
          ...
          <div class="box-footer">
                  <div class="form-actions floatRight">
					 <input type="submit" value="Save" id="Save"  class="btn btn-primary btn-flat margin">
				 	 <input type="button" value="Cancel" onclick="location.href='adminDeleteTenderList'" class="btn btn-success">
