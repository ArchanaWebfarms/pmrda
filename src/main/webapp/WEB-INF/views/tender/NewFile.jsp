...
<div class="box-body">
		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-6 invoice-col">
		          ...
		          <h5><b>Title : </b>${tendors.title_h}</h5>        
		          <h5><b>Sub Title : </b>${tendors.subTitle}</h5>
		          <h5><b>Description : </b>${tendors.description}</h5>        
		          <h5><b>Opening Date : </b>${tendors.openingDate}</h5>
		          <h5><b>Closing Date : </b>${tendors.closingDate}</h5>        
		          <h5><b>Publish Date : </b>${tendors.publish_date}</h5>
		          <h5><b>Tags : </b>${tendors.tags}</h5>
		          <h5><b>Department : </b>${tendorsDepartment.departmentName}</h5>
		          <h5><b>Status : </b>${tendors.publishStatus}</h5>
		        </div>
		      </div>
	          ...
	          <table  class="table table-striped">
	            ...
	            <tbody>
		            <tr>
							...
							<td>${tendors.attachment.attachmnt_name}</td>
							<td>${tendors.attachment.attachmnt_name}</td>
							<td><a href="attachmentDownload?path=${tendors.attachment.path}">Download</a></td>
		            </tr>   
	            </tbody>
	          </table>
		        </div>
		...
		<h3 class="lead">  <i class="fa fa-globe"></i> Change Status :</h3>
         ...
         <!-- /.box-header -->
      <section class="invoice">
      <form:form action="changeTendorStaus?${_csrf.parameterName}=${_csrf.token}" modelAttribute="tendors" commandName="tendors">
      
      <input type="hidden" name="tenderId" value="${tendors.tender_id }">
		<div class="row">
			<div class="form-group col-md-12">
				<label class="col-md-3 control-lable" for="tendorStatus">Change status</label>
				<span style="color: red" id="statusError"></span>
				<div class="col-md-7">
					<div class="input-group">
					  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
					  <select name="tendorStatus" id="status" class="form-control">
