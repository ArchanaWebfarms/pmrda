		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-12 invoice-col">
		           <h4><b>Title in English: </b>${News.title}</h4>   
		          ...
		          <h4><b>Description in English: </b>${News.description}</h4>   
		          <h4><b>Description in Marathi: </b>${News.description_h}</h4>
		          <h4><b>Creation By : </b>${News.user.firstName}&nbsp;${News.user.lastName}</h4>
