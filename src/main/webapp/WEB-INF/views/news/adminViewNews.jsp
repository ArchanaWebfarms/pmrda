  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="adminNewsList">Admin News List</a></li>
	...
	<!-- Default box -->
<div class="box-body">
 <form:form  action="NewsStatus?${_csrf.parameterName}=${_csrf.token}" modelAttribute="news" class="form-horizontal" commandName="news">
		...
		<p class="lead">  <i class="fa fa-bars" aria-hidden="true"></i> Basic Information :</p>
		 <input type="hidden"  id ="id" name ="id" value="${news.newsid}">
		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-12 invoice-col">
		            ...
		            <h5><b>Title in English: </b> ${news.title }</h5>
		              <h5><b>Title In Marathi : </b>${news.title_h}  </h5> 
		             <%--  <h5><b>News Paper : </b>${news.newspaper}</h5>   
		                <h5><b>News Paper In Marathi : </b>${news.newspaper_h}</h5>   
		              <h5><b>Sub Title : </b>${news.subtitle}</h5> --%>
		               <h5><b> Date : </b>${news.publish_date}</h5>
		          <h5><b>Description in English: </b>${news.description}</h5>        
		         <h5><b>Description in Marathi : </b>${news.description_h}</h5>      
		         <h5><b>Created By  : </b>${news.user.firstName}</h5>
		          <h5><b>Creation Date : </b>${news.created_date}</h5>
        ...
        <div class="col-xs-12 table-responsive">
         <p class="lead">  Attachment :</p>
          <table  class="table table-striped" id ="myTable">
            ...
            <tbody>
	           <c:forEach var="adminTenderList" items="${attachment}" varStatus="status">
							<tr>
								<td>${status.index + 1}</td>
								<td>${adminTenderList.attachmnt_name}</td>
									<td>${adminTenderList.module_type}</td>								
								<td><input type="button" value="Download" class="btn btn-primary btn-flat margin" onclick="return download(${adminTenderList.attachmentID})"/></td>								
							</tr>
					</c:forEach> 
            </tbody>
          </table>
          ...
          <div class="box-footer">
                  <div class="form-actions floatRight">
					 <input type="submit" value="Save" id="Save"  class="btn btn-primary btn-flat margin">
				 	 <input type="button" value="Cancel" onclick="location.href='adminNewsList'" class="btn btn-success">
