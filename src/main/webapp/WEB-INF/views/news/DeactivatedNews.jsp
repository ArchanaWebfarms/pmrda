		      ...
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-12 invoice-col">
		         ...
		         <h5><b>Description in Marathi : </b>${news.description_h}</h5>  
		          ...
		          <h5><b>Creation Approval Status : </b>${news.status}</h5> 	        	                
		          <h5><b>Creation Approval Date : </b>${news.approveddate}</h5>
		          <h5><b>Creation Approval Comment : </b>${news.comment}</h5>
		          <h5><b>Deletion Approval Status : </b>${news.delete_approval_status}</h5>
		          <h5><b>Deletion Approval Date : </b>${news.delete_approval_date}</h5>
		          <h5><b>Deletion Approval Comment : </b>${news.delete_approval_comment}</h5> 
            ...
            <tbody>
	           <c:forEach var="list" items="${attachment}" varStatus="status">
							<tr>
								...
								<td><input type="button" value="Download" class="btn btn-primary btn-flat margin" onclick="return download(${list.attachmentID})"/></td>							
