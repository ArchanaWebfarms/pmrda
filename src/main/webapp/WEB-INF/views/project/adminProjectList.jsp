 ...
 <div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Project Table<!-- <small>advanced tables</small> --></h1>
      <ol class="breadcrumb">
...
<input type="hidden" value="${adminprojectList}">

<form:form  action="adminviewProject" id="viewform" oncontextmenu="return false" onkeydown="return false;" onmousedown="return false;" >  	
...
function selectStatus(){
	...
	//alert(tendorStatus)
	$.ajax({
	    url : 'GetProjectbyStatus?tendorStatus='+tendorStatus,      
	    success : function(response){
	    	console.log(response)
	    	for(var i=0;i<response.length;i++){
	    		
	    		var status=response[i].approvedStatus;
	    		...
	    		if(status=='Approved'){
					...
					'<td class="A">'+response[i].approvedStatus+'</td>'+	
					'<td><input type="button" value="Change Status" class="btn btn-primary btn-flat margin" onclick="return view('+response[i].id+')"/></td>';
...
$( document ).ready(function() {
	$("#adminProjectDashboard").addClass("active");
