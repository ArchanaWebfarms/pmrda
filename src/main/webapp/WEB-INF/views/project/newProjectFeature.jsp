      ...
      <input type="hidden"  name="${_csrf.parameterName}"  value="${_csrf.token}" />
         ...
         <!-- SELECT2 EXAMPLE -->
                    <div class="box box-default">
                       <div class="box-header with-border">
                             <h3 class="box-title">Features Form</h3>
                                 ...
                                 <div class="box-body" >
		                                 ...
		                                 <div class="row"  id="title">
			                                 <div class="form-group col-md-12">
					                           <button type="button"  id ="AddMoreFields" class="btn bg-olive btn-flat margin">Add More Features</button>
				                              </div>
			                               </div>
		                              </div>
		...
		<div class="row"  id="valueDiv">
			<div class="form-group col-md-12">
				...
				<span style="color: red" id="valueError"></span>
				<div class="col-md-7">
					 <div class="input-group">
					 <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
...
var html = '<br><div class="row">'+
		    	  '<div class="form-group col-md-12">'+
					'<label class="col-md-3 control-lable" for="tags">Feature</label>'+
						'<div class="col-md-7">'+
							' <div class="input-group">'+
		      ...
		      '<div class="row">'+
			  '<div class="form-group col-md-12">'+
				'<label class="col-md-3 control-lable" for="tags">Value</label>'+
					'<div class="col-md-7">'+
						' <div class="input-group">'+
							'<span class="input-group-addon">'+
								'<i class="fa fa-pencil"></i></span>'+
