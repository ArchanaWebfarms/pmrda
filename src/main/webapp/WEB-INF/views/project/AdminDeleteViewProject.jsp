    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="home"><i class="fa fa-dashboard"></i> <b>Home</b></a></li>
         <li><a href="adminProjectDashboard">Admin Projectw Dashboard</a></li>      
        <li><a href="adminDeleteProjectList">Admin Project List</a></li>
...
<div class="box-body">
		...
		<form:form action="DeleteProjectStatus"  class="form-horizontal" >
          ...
          <div class="box-footer">
                  <div class="form-actions floatRight">
					 <input type="submit" value="Save" id="Save"  class="btn btn-primary btn-flat margin">
				 	 <input type="button" value="Cancel" onclick="location.href='adminDeleteProjectList'" class="btn btn-success">
