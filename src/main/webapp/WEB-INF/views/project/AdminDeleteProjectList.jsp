 ...
 <div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Project Data Table<!-- <small>advanced tables</small> --></h1>
      <ol class="breadcrumb">
...
<form:form  action="viewDeactivatedProject" id="viewDform" oncontextmenu="return false" onkeydown="return false;" onmousedown="return false;" >  	
  <input type="hidden" id="did" name="id" />  
  </form:form>
<form:form  action="adminDeleteViewProject" id="viewPform" oncontextmenu="return false" onkeydown="return false;" onmousedown="return false;" >  	
...
function selectStatus(){
	...
	var tendorStatus = $("#tendorStatus").val();//alert(tendorStatus)
		...
		$.ajax({
		    url : 'getProjectByDeleteStatus?tendorStatus='+tendorStatus,      
