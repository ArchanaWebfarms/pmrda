      ...
      <div class="box box-default">
        <div class="box-header with-border">
         ...
         <!-- /.box-header -->
           <div class="box-body" >
             <%--  <%String add=null;%>	 --%>
	<form:form method="POST" modelAttribute="rights" action="newRights?${_csrf.parameterName}=${_csrf.token}" class="form-horizontal">


		<form:hidden path="right_id"/>
		<form:hidden path="created_date"/>
		   <div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="firstName">Enter Right</label>
					<div class="col-md-7">
						<form:input type="text" path="right_type" id="right_type" class="form-control"/>
						<div class="has-error">
