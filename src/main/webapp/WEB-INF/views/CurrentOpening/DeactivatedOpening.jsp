  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="adminDeleteOpeningList">Admin Opening List</a></li>
        <li class="active">Deactivated Opening</li>
       </ol>
    </section>
		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-12 invoice-col">
		          ...
		          <h5><b>Creation Approval Status : </b>${opening.approval_status}</h5> 	        	                
		          <h5><b>Creation Approval Date : </b>${opening.approved_date}</h5>
		          <h5><b>Creation Approval Comment : </b>${opening.comment}</h5>
		          <h5><b>Deletion Approval Status : </b>${opening.delete_approval_status}</h5>
		          <h5><b>Deletion Approval Date : </b>${opening.delete_approval_date}</h5>
		          <h5><b>Deletion Approval Comment : </b>${opening.delete_approval_comment}</h5>
