		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-12 invoice-col">
		           <h4><b>Name of the Post in English : </b>${opening.post}</h4>   
		             <h4><b>Name of the Post in Marathi: </b>${opening.post_h}</h4>   
		            <h4><b>Required Number : </b>${opening.total_vacancy}</h4>	             
		          <h4><b>Department : </b>${opening.department.departmentName}</h4>
		          <h4><b>Opening Status : </b>${opening.opening_status}</h4> 	  
		          <h4><b>Admin Approval Status : </b>${opening.approval_status}</h4> 	        	                
		          <h4><b>Creation Date : </b>${opening.created_date}</h4>
