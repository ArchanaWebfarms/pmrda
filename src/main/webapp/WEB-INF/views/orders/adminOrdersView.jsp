...
<div class="wrapper" >
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Order Details <small>Preview</small> </h1>
      <ol class="breadcrumb">
	...
	<!-- Default box -->
<div class="box-body">
 <form:form  action="changeOrdersStaus?${_csrf.parameterName}=${_csrf.token}" modelAttribute="orders" class="form-horizontal" commandName="orders">
		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-6 invoice-col">
		            ...
		            <h5><b>Title : </b> <form:input path="title" style="border-style: none;"/></h5>
		            <h5><b>Title In Marathi : </b> <form:input path="title_h" style="border-style: none;"/></h5> 
		            <h5><b>Description : </b><form:input path="description" style="border-style: none;"/> </h5>        
		            <h5><b>Date: </b><form:input path="date" style="border-style: none;"/></h5>
		            <h5><b>Tags : </b><form:input path="tags" style="border-style: none;"/></h5>  
		            <h5><b>Type : </b><form:input path="type" style="border-style: none;"/></h5>        
		            <h5><b>Department : </b><form:input path="department.departmentName" style="border-style: none;"/></h5>
		        </div>
		      </div>
		...
		<div class="row">
            ...
            <tbody>
	            <tr>
						...
						<td>${orders.attachment.attachmnt_name}</td>
						<td><a id="no-link" href="attachmentDownload?path=${orders.attachment.path}">Download</a></td>
	            </tr>   
            </tbody>
          </table>
		        </div>
          ...
          <div class="box-footer">
                  <div class="form-actions floatRight">
					 <input type="submit" value="Save" id="Save"  class="btn btn-primary btn-flat margin">
				 	 <input type="button" value="Cancel" onclick="location.href='adminOrdersList'" class="btn btn-success">
