...
<div class="box-body">
		...
		<form:form action="saveAdminDeletionStatus"  class="form-horizontal" >
				...
				<div class="col-md-7">
				 <div class="input-group">
					 ...
					 <select name ="approvedStatus"  id="Approved"  class="form-control">
		              ...
		              <option value="Deactivate" >Approved</option>
          ...
          <div class="box-footer">
                  <div class="form-actions floatRight">
					 <input type="submit" value="Save" id="Save"  class="btn btn-primary btn-flat margin">
				 	 <input type="button" value="Cancel" onclick="location.href='adminDeleteDepartmentList'" class="btn btn-success">
