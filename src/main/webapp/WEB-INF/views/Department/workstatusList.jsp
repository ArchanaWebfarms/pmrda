      ...
      <div class="row">
        ...
        <div class="box">
            ...
            <div class="box-body">
				...
				<input type="button" onclick="location.href='addwrokstatus'" value="Add" class="btn btn-primary btn-flat margin">
				<input type="button" onclick="location.href='viewwrokstatus'" value="View" class="btn btn-primary btn-flat margin">
				</div>
            </div>
            <!-- /.box-body -->
         </div>
                ...
                <tbody>
					<c:forEach var="departments" items="${departments}" varStatus="status">
							<tr>
								...
								<td ><a style="color:  #007bff" href="viewDemoDepartment?deptId=${departments.id}">View Department</a></td>		
