  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="adminDeleteDepartmentList">Admin Departments List</a></li>
...
<div class="box-body">
 			<div class="box box-default">
					<div class="box-header with-border">
						<h3 class="box-title">Deactivated Department Information</h3>
					</div>
					<!-- /.box-header -->
		...
		<p class="lead">  <i class="fa fa-bars" aria-hidden="true"></i> Basic Information :</p>
			...
			<c:otherwise>
				<h5><b>Other Title in English : </b>${department.other_title}</h5> 	        	                
		          ...
		          <h5><b>Creation Approval Status : </b>${department.create_approval_status}</h5> 	        	                
		          <h5><b>Creation Approval Date : </b>${department.create_approval_date}</h5>
		          <h5><b>Creation Approval Comment : </b>${department.create_approval_comment}</h5>
		          <h5><b>Deletion Approval Status : </b>${department.delete_approval_status}</h5>
		          <h5><b>Deletion Approval Date : </b>${department.delete_approval_date}</h5>
		          <h5><b>Deletion Approval Comment : </b>${department.delete_approval_comment}</h5> 
