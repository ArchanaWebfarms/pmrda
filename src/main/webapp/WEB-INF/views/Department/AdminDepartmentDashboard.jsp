  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Admin Departments Dashboard</li>
      </ol>
    </section>
       ...
       <div class="col-lg-3 col-xs-6">
         <!--  small box -->
          <div class="small-box bg-blue">
            ...
            <a href="adminDepartmentList" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="adminDeleteDepartmentList" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
