...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>  Designations Details <small>Preview</small> </h1>
      <ol class="breadcrumb">
		    ...
		    <section class="invoice">
		      <div class="row invoice-info">
		        ...
		        <div class="col-sm-6 invoice-col">
		          <br>
		          <h4><b>Designation Name : </b>${designation.designation}</h4>        
		          <h4><b>Designation Description : </b>${designation.description}</h4>
		          <h4><b>Designation Name In Hindi : </b>${designation.designation_h}</h4>    
