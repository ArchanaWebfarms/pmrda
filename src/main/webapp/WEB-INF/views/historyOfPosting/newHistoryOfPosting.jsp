...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> History Of Posting  Registration Form  <!-- <small>Preview</small> --> </h1>
      <ol class="breadcrumb">
        <li><a href="index"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Forms</a></li>
        <li class="active">History Of Posting</li>
      </ol>
    </section>
	...
	<div class="box-body">
	 <form:form  action="saveHistoryOfPosting?${_csrf.parameterName}=${_csrf.token}" modelAttribute="orders"  enctype="multipart/form-data" class="form-horizontal" >
	<!-- Default box --><!-- method="POST" -->
     ...
     <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
      ...
      <div class="box box-default">
			...
			<div class="form-group col-md-12">
				...
				<div class="col-md-7">
					<div class="input-group">
					  ...
					  <form:input type="text" path="title" id="title" class="form-control" onkeyup="GetSpecailCharactor()"/>
				    </div> 
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group col-md-12">
				<label class="col-md-3 control-lable" for="title">Name In Hindi</label>
				<span style="color: red" id="title_hError"></span>
				<div class="col-md-7">
					<div class="input-group">
					  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
      ...
      <div class="box box-default">
		...
		<div class="row" id="select">
			<div class="form-group col-md-12">
				...
				<span style="color: red" id="designationError"></span>
			</div>
		</div>
            ...
            <tbody>
	          ...
	          <div class="box-footer">
                  <div class="form-actions floatRight">
					 <input type="submit" value="Save" id="Save" onclick="return myFunction()" class="btn btn-primary btn-flat margin"><%--  or <a href="<c:url value='/admin' />">Cancel</a> --%>
